...
# interact
# 1. svn checkout from svn://192.168.0.200/script/trunk/packages
#    cp  "./packages/redist/_assetmanifest.ftp.uploader.txt" assetmanifest.txt
#
# 2. wget "http://192.168.0.228/assetdownload/list/ftpsvrlist0.txt" -O ./ftpsvrlist0.txt
# 3. wget "http://192.168.0.228/assetdownload/list/ftpsvrlist.txt" -O ./ftpsvrlist.txt
#
# 4. ftp upload to server.228
#    "open 192.168.0.228" >> tftpasset.sh
#    "user ftpasset ftpparaengine" >> tftpasset.sh
#    ftpasset user in 228, root is /home/upload/asset/
#
# 5. ./svr_auto.sh "192.168.0.228" "paraengine" "/usr/local/script/renew_assetlist/chown_varwww.sh"
